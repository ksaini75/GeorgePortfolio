      ...
      <Navbar expand="lg">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="ml-auto mx-auto nav " >
                  ...
                  <Nav.Item><Nav.Link activeclassname="selected" href="#projects" className="ml-4 mr-4">Projects</Nav.Link></Nav.Item>
                  <Nav.Item><Nav.Link activeclassname="selected" href="#contact" className="ml-4 mr-4 mb-2">Contact</Nav.Link></Nav.Item>
              </Nav>
